    ...
    <div style={{ fontFamily:"'DM Sans',sans-serif", minHeight:'100vh', background:'#F5F0E8', padding:'40px' }}>
      ...
      <div style={{background:'#fff', borderRadius:'20px', padding:'40px', maxWidth:'800px', margin:'0 auto', boxShadow:'0 4px 20px rgba(0,0,0,0.08)'}}>
        <div style={{display:'flex', gap:'40px', flexWrap:'wrap'}}>
          <div style={{background:'#F5F0E8', borderRadius:'16px', width:'280px', height:'280px', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'7rem', flexShrink:0}}>
            {produit.categorie === 'froid' ? '🧊' : produit.categorie === 'cuisine' ? '🍳' : produit.categorie === 'lavage' ? '🫧' : '⚡'}
          </div>
          <div style={{flex:1}}>
