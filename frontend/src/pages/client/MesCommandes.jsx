      ...
      <div style={styles.container}>
        ...
        {commandes.length === 0 ? (
          ...
          <div key={c._id} style={styles.card}>
            <div style={styles.cardHeader} className="responsive-card-row">
              <div>
            ...
            <div style={styles.cardBody} className="responsive-card-row">
...
const styles = {
  page: { minHeight: '100vh', background: 'var(--em-page)', fontFamily: "'DM Sans',sans-serif" },
  ...
  container: { maxWidth: '700px', margin: '0 auto', padding: 'clamp(24px, 6vw, 40px) 20px' },
  titre: { fontSize: 'clamp(1.35rem, 5vw, 1.8rem)', fontWeight: '700', marginBottom: '28px', color: '#1C1C1C' },
  vide: { textAlign: 'center', padding: '60px 0', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', color: '#888' },
  card: { background: 'var(--em-surface)', borderRadius: '8px', padding: '22px', marginBottom: '16px', boxShadow: 'var(--em-shadow-sm)', border: '1px solid var(--em-border)' },
  ...
  cardBody: { display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem', color: '#666', marginBottom: '14px', gap: '8px' },
  montant: { fontWeight: '800', color: '#1A3A2A', fontSize: '1rem' },
  btnDetail: { background: 'rgba(200,65,10,0.08)', color: '#C8410A', border: '1px solid rgba(200,65,10,0.14)', padding: '8px 18px', borderRadius: '8px', cursor: 'pointer', fontSize: '0.85rem', fontWeight: '700' },
  btnPrimaire: { background: 'linear-gradient(135deg, #C8410A, #E8622A)', color: '#fff', padding: '12px 28px', borderRadius: '8px', fontWeight: '700', fontSize: '0.93rem', textDecoration: 'none', display: 'inline-block', boxShadow: '0 12px 28px rgba(200,65,10,0.22)' },
  ...
  modal: { background: 'var(--em-surface)', borderRadius: '8px', padding: '36px', width: '100%', maxWidth: '480px', maxHeight: '90vh', overflowY: 'auto', boxShadow: 'var(--em-shadow-lg)' },
