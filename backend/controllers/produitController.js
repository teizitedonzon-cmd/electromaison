...
// Logique identique à l'originale.
// Seuls 3 endroits changent (marqués ✅) :
//   creerProduit   → f.path  (URL Cloudinary)
//   modifierProduit → f.path + suppression ancienne image
//   supprimerProduit → suppression images Cloudinary
// ============================================
const Produit  = require('../models/Produit');
const Commande = require('../models/Commande');
